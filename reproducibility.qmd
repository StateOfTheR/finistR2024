...
3) Use the `renv::restore()` function to install the required packages for the project (ensuring the correct versions).
...
Here is what happened with ubuntu 22.04, with a the 4.4.1 version of R.
